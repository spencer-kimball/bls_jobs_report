nlf_desire_funct <- function(input){
        ...
        seriesid <- c('LNU05000000','LNU05027039','LNU05026639','LNU05027045','LNU05027496',
                      'LNU05027054','LNU05026642','LNU05026645','LNU05026648','LNU05027069',
                      'LNU05027075','LNU05027081','LNU05027695')
        
        group <- c('Total.NLF','Dont.Want', 'Want','No.Search.Year', 'No.Search.4.Weeks','Not.Available',
                   'Marginally.Attached','Discouraged','Other.Than.Discouraged', 'Family',
                   'School.Training', 'Illness.Disability', 'Other')  
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "nlf_by_desire" )
        return(alldemo2)

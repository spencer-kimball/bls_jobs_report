reason_pct_funct <- function(input){
        ...
        seriesid <- c('LNS13023622','LNS13023654','LNS13026511','LNS13023706','LNS13023558','LNS13023570')
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "pct_reason_unemp")
        return(alldemo2)
}
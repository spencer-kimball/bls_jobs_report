reason_unemp_funct <- function(input){
        ...
        seriesid <-  c('LNS13000000','LNS13023621','LNS13023653','LNS13025699','LNS13026638','LNS13026637','LNS13023705','LNS13023557','LNS13023569')
        
        group <- c('Total.Unemp', 'Joblosers$TempJob', 'Temp.Layoff', 'Not.Temp.Layoff', 'Perm.Job.Loss', 'Temp.Job.Done', 'Job.Leaver', 'Reentrants', 'New.Entrants')
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "reason_unemp")
        return(alldemo2)
}
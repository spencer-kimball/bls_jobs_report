hispanic_reason_unemp_funct <- function(input){
        ...
        seriesid <- c("LNU03023751", "LNU03023752", "LNU03023753", "LNU03023754", "LNU03023755", "LNU03023756")
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "hispanic_reason_unemp")
        return(alldemo2)
}
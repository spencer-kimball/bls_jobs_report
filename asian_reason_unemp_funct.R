asian_reason_unemp_funct <- function(input){
        ...
        seriesid <- c('LNU03034295', 'LNU03034296', 'LNU03034297', 'LNU03034298', 'LNU03034299', 'LNU03034300')
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "asian_reason_unemp")
        return(alldemo2)
}
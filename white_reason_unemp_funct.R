white_reason_unemp_funct <- function(input){
        ...
        seriesid <- c("LNU03023626", "LNU03023658", "LNU03026518", "LNU03023710", "LNU03023562", "LNU03023574")
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "white_reason_unemp")
        return(alldemo2)
}
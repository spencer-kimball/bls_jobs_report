emp_pop_ratio_funct <- function(input){
        ...
        seriesid <-  c('LNS12300000', 'LNS12300001', 'LNS12300002', 'LNS12300003', 
                       'LNS12300006', 'LNS12300009', 'LNU02332183','LNS12300028', 
                       'LNS12300029', 'LNS12300031', 'LNS12300032', 'LNS12300034','LNS12300035')
        
        group <- c('Emp.Pop.Ratio','Men', 'Women','White','Black', 'Hispanic', 'Asian.Unadj',
                   'White.Men.20','White.Women.20', 'Black.Men.20', 'Black.Women.20', 
                   'Hispanic.Men.20', 'Hispanic.Women.20')
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "employment_pop_ratio")
        return(alldemo2)
} 
unemp_level_funct <- function(input){
        ...
        seriesid <-  c("LNS13000000", "LNS13000001", "LNS13000002", "LNS13000003", "LNS13000006",
                       "LNS13000009", "LNS13032183", "LNS13000028", "LNS13000029", "LNS13000031",
                       "LNS13000032", "LNU03000034","LNU03000035")
        
        group <- c("Unemp.Level","Men", "Women", "White", "Black", "Hispanic", "Asian", "White.Men.20", "White.Women.20",
                    "Black.Men.20","Black Women.20", "Hispanic.Men.20.Unadj", "Hispanic.Women.20.Unadj")
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "umemp_level" )
        return(alldemo2)
}
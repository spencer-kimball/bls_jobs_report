labor_force_funct <- function(input){
        ...
        group <- c("Labor.Part.Rate","Men","Women", "White", "Black", "Hispanic","Asian",
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "labor_part_rate" )
        return(alldemo2)

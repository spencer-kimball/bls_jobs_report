youth_unemp_funct <- function(input){
        ...
        seriesid <-  c("LNS14000012", "LNS14000013", "LNS14000014", "LNS14000015", 
                       "LNS14000016", "LNS14000017", "LNS14000018", "LNS14000019", 
                       "LNS14000020", "LNU04000012", "LNU04000013", "LNU04000014",
                       "LNU04000015", "LNU04000016", "LNU04000017", "LNU04000018", 
                       "LNU04000019", "LNU04000020", "LNU04032245", "LNU04032307", 
                       "LNU04032348", "LNU04000021", "LNU04000022", "LNU04000023")
        
        group <- c("Unemp.Rate","Men", "Women", "White", "White.Men", "White.Women",
                   "Black", "Black.Men", "Black.Women", "Unemp.Rate.Unadj", "Men.Unadj", "Women.Unadj",
                   "White.Undaj", "White.Men.Unadj", "White.Women.Unadj", "Black.Unadj",
                   "Black.Men.Unadj", "Black.Women.Unadj", "Asian.Unadj", "Asian.Men.Unadj",
                   "Asian.Women.Unadj", "Hispanic.Unadj", "Hispanic.Men.Unadj", "Hispanic.Women.Unadj")
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "youth(16-19)_unemp_rate" )
        return(alldemo2)
}
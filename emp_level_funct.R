emp_level_funct <- function(input){
        ...
        seriesid <-  c("LNS12000024", "LNS12000025", "LNS12000026", "LNS12000027", "LNS12000028", "LNS12000029", 
                       "LNS12000006", "LNS12000031", "LNS12000032", "LNS12000033", "LNS12000034", "LNS12000035", 
                       "LNS1203218", "LNU02032266", "LNU02032267")
        
        group <- c("Emp.Level","Men", "Women", "White", "Black", "Hispanic", "Asian", "White.Men.20", "White.Women.20",
                   "Black.Men.20","Black Women.20","Hispanic.Men.20", "Hispanic.Women.20", "Asian.Men.20.Unadj", "Asian.Women.20.Unadj")
        ...
        sheet_write(alldemo2, ss = "145k5urPZXczvQR7isiJFxxWku_A3upqwr3kpfof9v-c", sheet = "emp_level" )
        return(alldemo2)
}